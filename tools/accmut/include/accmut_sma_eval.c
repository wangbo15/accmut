...
static int COVERED_LOCATIONS[MAXINDEXNUM];

static long ORIRES[MAXINDEXNUM];

static long MUTRES[MAXMUTNUM];

static int UNSUPORTED[MAXMUTNUM];

static int PARENT[MAXMUTNUM];
