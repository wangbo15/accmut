...
%struct.Mutation = type { i32, i32, i32, i32, i32, i32, i32, i32, i32 }
...
@.str.13 = private unnamed_addr constant [37 x i8] c"ERROR : __accmut__cal_i32_arith !!!\0A\00", align 1
@.str.14 = private unnamed_addr constant [37 x i8] c"ERROR : __accmut__cal_i64_arith !!!\0A\00", align 1
@.str.15 = private unnamed_addr constant [16 x i8] c"FORK ERROR !!!\0A\00", align 1
@.str.16 = private unnamed_addr constant [17 x i8] c"ORIG RESULT : %d\00", align 1
@.str.17 = private unnamed_addr constant [18 x i8] c"ORIG RESULT : %ld\00", align 1
@.str.18 = private unnamed_addr constant [35 x i8] c"ERROR : __accmut_cal_i32_bool !!!\0A\00", align 1
@.str.19 = private unnamed_addr constant [36 x i8] c"ERROR : __accmut__cal_i64_bool !!!\0A\00", align 1
...
while.body:                                       ; preds = %while.cond
  ...
  %call13 = call noalias i8* @malloc(i64 36) #7
...
if.then.17:                                       ; preds = %while.body
  ...
  store i32 %8, i32* %t_op21, align 4
  br label %if.end.66
...
if.then.25:                                       ; preds = %if.else
  ...
  store i32 %12, i32* %t_op31, align 4
  br label %if.end.65
...
if.then.36:                                       ; preds = %if.else.32
  ...
  store i32 %18, i32* %t_pre42, align 4
  br label %if.end.64
...
if.then.57:                                       ; preds = %if.else.53
  ...
  %call60 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %arraydecay59, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.12, i32 0, i32 0), i32* %op58, i32* %op_i, i32* %s_c, i32* %t_c) #7
  ...
  store i32 %26, i32* %op_index, align 4
  %28 = load i32, i32* %s_c, align 4
  ...
  store i32 %28, i32* %s_con, align 4
  %30 = load i32, i32* %t_c, align 4
  ...
  store i32 %30, i32* %t_con, align 4
  br label %if.end.62
...
sw.default:                                       ; preds = %entry
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.13, i32 0, i32 0))
  call void @exit(i32 0) #6
  unreachable
...
if.then.2:                                        ; preds = %if.then
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.15, i32 0, i32 0))
  call void @exit(i32 0) #6
  unreachable
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.16, i32 0, i32 0), i32 %5)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [10001 x %struct.Mutation*], [10001 x %struct.Mutation*]* @ALLMUTS, i64 0, i64 %idxprom2
  %10 = load %struct.Mutation*, %struct.Mutation** %arrayidx3, align 8
  store %struct.Mutation* %10, %struct.Mutation** %m, align 8
  %11 = load %struct.Mutation*, %struct.Mutation** %m, align 8
  %t_op = getelementptr inbounds %struct.Mutation, %struct.Mutation* %11, i32 0, i32 2
  %12 = load i32, i32* %t_op, align 4
  %13 = load i32, i32* %left.addr, align 4
  %14 = load i32, i32* %right.addr, align 4
  %call4 = call i32 @__accmut__cal_i32_arith(i32 %12, i32 %13, i32 %14)
  store i32 %call4, i32* %mut_res, align 4
  %15 = load i32, i32* %ori, align 4
  %16 = load i32, i32* %mut_res, align 4
  %cmp5 = icmp ne i32 %15, %16
  br i1 %cmp5, label %if.then, label %if.end.9

if.then:                                          ; preds = %for.body
  %17 = load i32, i32* %i, align 4
  %call6 = call i32 @__accmut__fork(i32 %17)
  store i32 %call6, i32* %pid, align 4
  %18 = load i32, i32* %pid, align 4
  %cmp7 = icmp sgt i32 %18, 0
  br i1 %cmp7, label %if.then.8, label %if.end

if.then.8:                                        ; preds = %if.then
  %19 = load i32, i32* %mut_res, align 4
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.17, i32 0, i32 0), i64 %5)
  %6 = load i32, i32* %from.addr, align 4
  store i32 %6, i32* %i, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %t_op = getelementptr inbounds %struct.Mutation, %struct.Mutation* %11, i32 0, i32 2
  %12 = load i32, i32* %t_op, align 4
  %13 = load i64, i64* %left.addr, align 8
  %14 = load i64, i64* %right.addr, align 8
  %call4 = call i64 @__accmut__cal_i64_arith(i32 %12, i64 %13, i64 %14)
  store i64 %call4, i64* %mut_res, align 8
  %15 = load i64, i64* %ori, align 8
  %16 = load i64, i64* %mut_res, align 8
...
if.then.8:                                        ; preds = %if.then
  %19 = load i64, i64* %mut_res, align 8
...
sw.default:                                       ; preds = %entry
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.18, i32 0, i32 0))
  call void @exit(i32 0) #6
  unreachable
...
sw.default:                                       ; preds = %entry
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.19, i32 0, i32 0))
  call void @exit(i32 0) #6
  unreachable
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [10001 x %struct.Mutation*], [10001 x %struct.Mutation*]* @ALLMUTS, i64 0, i64 %idxprom1
  %9 = load %struct.Mutation*, %struct.Mutation** %arrayidx2, align 8
  store %struct.Mutation* %9, %struct.Mutation** %m, align 8
  %10 = load %struct.Mutation*, %struct.Mutation** %m, align 8
  %t_pre = getelementptr inbounds %struct.Mutation, %struct.Mutation* %10, i32 0, i32 4
  %11 = load i32, i32* %t_pre, align 4
  %12 = load i32, i32* %left.addr, align 4
  %13 = load i32, i32* %right.addr, align 4
  %call3 = call i32 @__accmut__cal_i32_bool(i32 %11, i32 %12, i32 %13)
  store i32 %call3, i32* %mut_res, align 4
  %14 = load i32, i32* %ori, align 4
  %15 = load i32, i32* %mut_res, align 4
  %cmp4 = icmp ne i32 %14, %15
  br i1 %cmp4, label %if.then, label %if.end.8

if.then:                                          ; preds = %for.body
  %16 = load i32, i32* %i, align 4
  %call5 = call i32 @__accmut__fork(i32 %16)
...
if.then.7:                                        ; preds = %if.then
  %18 = load i32, i32* %mut_res, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [10001 x %struct.Mutation*], [10001 x %struct.Mutation*]* @ALLMUTS, i64 0, i64 %idxprom2
  %9 = load %struct.Mutation*, %struct.Mutation** %arrayidx3, align 8
  store %struct.Mutation* %9, %struct.Mutation** %m, align 8
  %10 = load %struct.Mutation*, %struct.Mutation** %m, align 8
  %t_pre = getelementptr inbounds %struct.Mutation, %struct.Mutation* %10, i32 0, i32 4
  %11 = load i32, i32* %t_pre, align 4
  %12 = load i64, i64* %left.addr, align 8
  %13 = load i64, i64* %right.addr, align 8
  %call4 = call i32 @__accmut__cal_i64_bool(i32 %11, i64 %12, i64 %13)
  store i32 %call4, i32* %mut_res, align 4
  %14 = load i64, i64* %ori, align 8
  %15 = load i32, i32* %mut_res, align 4
  %conv5 = sext i32 %15 to i64
  %cmp6 = icmp ne i64 %14, %conv5
  br i1 %cmp6, label %if.then, label %if.end.12

if.then:                                          ; preds = %for.body
  %16 = load i32, i32* %i, align 4
  %call8 = call i32 @__accmut__fork(i32 %16)
...
; Function Attrs: nounwind uwtable
define i32 @test_ari(i32 %a, i32 %b) #0 {
entry:
  %a.addr = alloca i32, align 4
  %b.addr = alloca i32, align 4
...
; Function Attrs: nounwind uwtable
define i64 @test_ari_l(i32 %a, i64 %b) #0 {
entry:
  %a.addr = alloca i32, align 4
  %b.addr = alloca i64, align 8
  store i32 %a, i32* %a.addr, align 4
...
; Function Attrs: nounwind uwtable
define i32 @test_cmp(i32 %a, i32 %b) #0 {
entry:
  %retval = alloca i32, align 4
  %a.addr = alloca i32, align 4
  %b.addr = alloca i32, align 4
...
; Function Attrs: nounwind uwtable
define i64 @test_cmp_l(i64 %a, i64 %b) #0 {
entry:
  %retval = alloca i64, align 8
  %a.addr = alloca i64, align 8
  %b.addr = alloca i64, align 8
...
; Function Attrs: nounwind uwtable
define i32 @callee_i32(i32 %a, i32 %b) #0 {
entry:
  %a.addr = alloca i32, align 4
  %b.addr = alloca i32, align 4
  store i32 %a, i32* %a.addr, align 4
...
; Function Attrs: nounwind uwtable
define i64 @callee_l(i32 %a, i8 signext %b) #0 {
entry:
  %a.addr = alloca i32, align 4
...
; Function Attrs: nounwind uwtable
define void @callee_void(i32 %a) #0 {
entry:
  %a.addr = alloca i32, align 4
  store i32 %a, i32* %a.addr, align 4
  ret void
...
entry:
  ...
  %0 = load i32, i32* %a.addr, align 4
  %1 = load i32, i32* %b.addr, align 4
  %call = call i32 @test_ari(i32 %0, i32 %1)
  store i32 %call, i32* %c, align 4
  %2 = load i32, i32* %a.addr, align 4
  %3 = load i32, i32* %b.addr, align 4
  %call1 = call i32 @test_cmp(i32 %2, i32 %3)
  store i32 %call1, i32* %d, align 4
  %4 = load i32, i32* %a.addr, align 4
  %5 = load i32, i32* %b.addr, align 4
  %call2 = call i32 @callee_i32(i32 %4, i32 %5)
  store i32 %call2, i32* %e, align 4
  %6 = load i32, i32* %d, align 4
  call void @callee_void(i32 %6)
...
; Function Attrs: nounwind uwtable
define i64 @test_l(i64 %a, i64 %b) #0 {
entry:
  %a.addr = alloca i64, align 8
  %b.addr = alloca i64, align 8
  ...
  %1 = load i64, i64* %b.addr, align 8
  %call = call i64 @test_ari_l(i32 %conv, i64 %1)
  store i64 %call, i64* %c, align 8
  %2 = load i64, i64* %a.addr, align 8
  %3 = load i64, i64* %b.addr, align 8
  %call1 = call i64 @test_cmp_l(i64 %2, i64 %3)
  store i64 %call1, i64* %d, align 8
  %4 = load i64, i64* %a.addr, align 8
  %conv2 = trunc i64 %4 to i32
  %5 = load i64, i64* %b.addr, align 8
  %conv3 = trunc i64 %5 to i8
  %call4 = call i64 @callee_l(i32 %conv2, i8 signext %conv3)
...
entry:
  ...
  %2 = load i32, i32* %res, align 4
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.20, i32 0, i32 0), i32 %2)
  store i64 888, i64* %c, align 8
  store i64 999, i64* %d, align 8
  %3 = load i64, i64* %c, align 8
  %4 = load i64, i64* %d, align 8
  %call2 = call i64 @test_l(i64 %3, i64 %4)
  store i64 %call2, i64* %res_l, align 8
  %5 = load i64, i64* %res_l, align 8
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.21, i32 0, i32 0), i64 %5)
  ret i32 0
}
