...
the other is dynamic mutation analysis. AccMut is developed integrated into 
...
path $HOME/tmp/accmut/mutations.txt. Make sure the directory has already 
existed. This file contains all mutations generated. Each line represents a LLVM-IR 
level mutation.
